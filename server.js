...
const MODES = {
  ...
  botc: {
    ...
    roles: {
      ...
      scarlet_woman:  { name: '绯红女郎', emoji: '🕷️', team: 'wolf' },
      spy:            { name: '间谍', emoji: '🕵️', team: 'wolf' },
      baron:          { name: '男爵', emoji: '🎩', team: 'wolf' },
      poisoner:       { name: '毒师', emoji: '☠️', team: 'wolf' },
    ...
    roleOrder: ['demon', 'scarlet_woman', 'spy', 'baron', 'poisoner', 'fortune_teller', 'undertaker', 'monk', 'ravenkeeper', 'virgin', 'chambermaid', 'empath', 'washerwoman', 'investigator', 'saint', 'slayer', 'soldier', 'mayor', 'chef', 'librarian', 'drunk', 'recluse', 'butler'],
    presets: {},
